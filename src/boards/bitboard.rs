...
impl Bitboard {
  ...
  pub fn exclude_square(&self, sq: Square) -> Bitboard {
    Bitboard::from(self.bb & !(1 << sq as u64))
  }

  pub fn swap_bytes(&self) -> Bitboard {
    Bitboard { bb: self.bb.swap_bytes() }
  }
}
